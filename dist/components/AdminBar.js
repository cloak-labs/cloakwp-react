...
const AdminBar = ({ className, enableRestApiLink = true, alwaysVisible = false, ...props }) => {
    ...
    const { url, adminPath } = (0, cloakwp_1.getCMSInstance)();
    const status = {
        publish: "published",
        draft: "draft",
        pending: "pending",
