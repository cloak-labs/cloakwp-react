...
export const AdminBar = ({ className, enableRestApiLink = true, alwaysVisible = false, ...props }) => {
    ...
    return (_jsx(_Fragment, { children: (alwaysVisible || isLoggedIn) && (_jsxs("div", { id: "cloakwp-admin-bar", className: cx("relative h-[38px] z-[101] flex items-center dark text-root-dim border-b border-root py-1.5", isCollapsed
                ...
                : "w-full px-3 bg-root", className), ...props, children: [!isCollapsed && (_jsxs("div", { className: "flex w-full gap-x-2 sm:gap-x-6 mb-0 text-sm", children: [_jsxs("a", { href: wpAdminHandshakePath(`${adminPath}/edit.php`), target: "_blank", className: "flex items-center", children: [_jsx(HomeIcon, { className: "mr-1.5" }), _jsx("span", { className: "hidden sm:flex", children: "Dashboard" })] }), pageData && (_jsxs("a", { href: wpAdminHandshakePath(`${adminPath}/post.php?post=${pageData.id}&action=edit`), target: "_blank", className: "flex items-center", children: [_jsx(EditIcon, { className: "mr-1.5" }), _jsx("span", { className: "hidden sm:flex", children: "Edit Page" })] })), enableRestApiLink && (_jsxs("a", { href: pageData?._links?.self[0]?.href, target: "_blank", className: "flex items-center", children: [_jsx(EyeIcon, { className: "mr-1.5" }), _jsx("span", { className: "hidden sm:flex", children: "REST API" })] })), isPreview && (_jsx(Button, { variants: { size: "sm", variant: "secondary" }, className: "ml-auto", asChild: true, children: _jsx(Link, { href: `/api/cloakwp/exit-preview?pathname=${pageData.pathname}`, openInNewTab: false, children: "Exit Preview" }) })), pageData && (_jsxs("div", { className: cx("flex items-center gap-x-2 text-sm", !isPreview && "ml-auto"), children: ["Status:", _jsx("span", { className: "rounded-full bg-root text-root dark:bg-root-invert dark:text-root-invert py-0.5 px-2 uppercase tracking-normal text-xs font-medium", children: status })] })), isLoggedIn && (_jsx(LogoutForm, { redirect: typeof pageData?.pathname === "string" &&
                                pageData.pathname !== ""
                                ? pageData.pathname
                                : "/", className: cx("flex items-center [&_button]:flex [&_button]:cursor-pointer [&_button]:items-center [&_button]:border-0 [&_button]:bg-transparent [&_button]:p-0 [&_button]:text-inherit", !pageData && !isPreview && "ml-auto") })), _jsx("div", { className: "absolute right-9 top-0 w-px h-full bg-root-invert-dim/20" })] })), _jsx(DoubleChevronIcon, { className: [
